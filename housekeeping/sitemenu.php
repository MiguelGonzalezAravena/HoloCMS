...
?>
  <div class="menuouterwrap">
    <div class="menucatwrap"><img src="<?php echo $housekeeping; ?>images/menu_title_bullet.gif" style="vertical-align:bottom" border="0" /> Configuration & Setup</div>
  ...
  <br />
  <div class="menuouterwrap">
    <div class="menucatwrap"><img src="<?php echo $housekeeping; ?>images/menu_title_bullet.gif" style="vertical-align:bottom" border="0" /> Collectables</div>
    <div class="menulinkwrap">&nbsp;
      <img src="<?php echo $housekeeping; ?>images/item_bullet.gif" border="0" alt="" valign="absmiddle">&nbsp;
  ...
  <br />
  <div class="menuouterwrap">
    <div class="menucatwrap"><img src="<?php echo $housekeeping; ?>images/menu_title_bullet.gif" style="vertical-align:bottom" border="0" /> Recommended Items</div>
    <div class="menulinkwrap">&nbsp;
      <img src="<?php echo $housekeeping; ?>images/item_bullet.gif" border="0" alt="" valign="absmiddle">&nbsp;
  ...
  <br />
  <div class="menuouterwrap">
    <div class="menucatwrap"><img src="<?php echo $housekeeping; ?>images/menu_title_bullet.gif" style="vertical-align:bottom" border="0" /> Content Management</div>
    <div class="menulinkwrap">&nbsp;
      <img src="<?php echo $housekeeping; ?>images/item_bullet.gif" border="0" alt="" valign="absmiddle">&nbsp;
  ...
  <br />
  <div class="menuouterwrap">
    <div class="menucatwrap"><img src="<?php echo $housekeeping; ?>images/menu_title_bullet.gif" style="vertical-align:bottom" border="0" /> Database Tools</div>
    <div class="menulinkwrap">&nbsp;
      <img src="<?php echo $housekeeping; ?>images/item_bullet.gif" border="0" alt="" valign="absmiddle">&nbsp;
