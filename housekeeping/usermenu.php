...
?>
  <div class="menuouterwrap">
    <div class="menucatwrap"><img src="<?php echo $housekeeping; ?>images/menu_title_bullet.gif" style="vertical-align:bottom" border="0" /> User Management</div>
  ...
  <br />
  <div class="menuouterwrap">
    <div class="menucatwrap"><img src="<?php echo $housekeeping; ?>images/menu_title_bullet.gif" style="vertical-align:bottom" border="0" /> Editors</div>
    <div class="menulinkwrap">&nbsp;
      <img src="<?php echo $housekeeping; ?>images/item_bullet.gif" border="0" alt="" valign="absmiddle">&nbsp;
  ...
  <?php /* ?>
    <div class="menuouterwrap">
      <div class="menucatwrap"><img src="<?php echo $housekeeping; ?>images/menu_title_bullet.gif" style="vertical-align:bottom" border="0" /> Application management</div>
      <div class="menulinkwrap">&nbsp;
        <img src="<?php echo $housekeeping; ?>images/item_bullet.gif" border="0" alt="" valign="absmiddle">&nbsp;
    ...
    <?php */ ?>
  <div class="menuouterwrap">
    <div class="menucatwrap"><img src="<?php echo $housekeeping; ?>images/menu_title_bullet.gif" style="vertical-align:bottom" border="0" /> Credits</div>
    <div class="menulinkwrap">&nbsp;
      <img src="<?php echo $housekeeping; ?>images/item_bullet.gif" border="0" alt="" valign="absmiddle">&nbsp;
  ...
  <br />
  <div class="menuouterwrap">
    <div class="menucatwrap"><img src="<?php echo $housekeeping; ?>images/menu_title_bullet.gif" style="vertical-align:bottom" border="0" /> Moderation</div>
    <div class="menulinkwrap">&nbsp;
      <img src="<?php echo $housekeeping; ?>images/item_bullet.gif" border="0" alt="" valign="absmiddle">&nbsp;
  ...
  <br />
  <div class="menuouterwrap">
    <div class="menucatwrap"><img src="<?php echo $housekeeping; ?>images/menu_title_bullet.gif" style="vertical-align:bottom" border="0" /> Customer Support</div>
    <div class="menulinkwrap">&nbsp;
      <img src="<?php echo $housekeeping; ?>images/item_bullet.gif" border="0" alt="" valign="absmiddle">&nbsp;
  ...
  <br />
  <div class="menuouterwrap">
    <div class="menucatwrap"><img src="<?php echo $housekeeping; ?>images/menu_title_bullet.gif" style="vertical-align:bottom" border="0" /> Logs & Statistics</div>
    <div class="menulinkwrap">&nbsp;
      <img src="<?php echo $housekeeping; ?>images/item_bullet.gif" border="0" alt="" valign="absmiddle">&nbsp;
