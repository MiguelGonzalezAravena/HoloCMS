...
if(!empty($text) && !empty($banner) && !empty($url) && isset($status) && isset($advanced)) {
  if(!empty($add)) {
            ...
            <div class="tableborder">
              ...
              <table width="100%" cellspacing="0" cellpadding="5" align="center" border="0">
                ...
                <tr>
                  ...
                  <td class="tablerow2" width="60%" valign="middle">
                    <textarea name="html" cols="61" rows="3" wrap="soft" id="sub_desc" class="multitext"><?php echo HoloText($row['html']); ?></textarea>
                  </td>
                </tr>
                <tr>
                  <td class="tablerow1" width="40%" valign="middle"><b>Enable/disable</b>
